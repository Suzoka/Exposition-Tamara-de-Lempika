                ...
                <div class="etape">
                    ...
                    <form action="./test.php" method="post">
                        ...
                        <div id="step3">
                            ...
                            <div class="boutons">
                                <button class="retour" type="button" data-goto="2" data-from="3">Retour</button>
                                <button type="button"
                        ...
                        <div id="step4">
                            ...
                            <div class="resumes">
                                ...
                                <div class="resume">
                                    <div class="resumeChamp">
                                        ...
                                        <button type="button" data-goto="1" data-from="4" class="edit"><img src="../img/icons/edit.svg" alt="">modifier</button>
                                    </div>
                                    <div class="resumeChamp">
                                ...
                                <div class="formulesResume">
                                    ...
                                    <button type="button" data-goto="2" data-from="4" class="edit"><img src="../img/icons/edit.svg" alt="">modifier</button>
                                </div>
                                ...
                                <div class="resume">
                                    <div class="resumeChamp">
                                        ...
                                        <button type="button" data-goto="3" data-from="4" class="edit"><img src="../img/icons/edit.svg" alt="">modifier</button>
                                    </div>
                            ...
                            <div class="boutons"><button class="retour" type="button" data-goto="3" data-from="4">Retour</button><input type="submit" value="Confirmer"></div>
                        </div>
                    </form>
                </div>
            </section>
