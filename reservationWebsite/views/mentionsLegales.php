    ...
    <main id="content">
        ...
        <section>
            ...
            <ul>
                ...
                <li>Propriétaires : MEROUANE Idriss, BOIREAU Nahina, VIGIER Robin, BANSRONT Thomas, ZARKA Morgan, DUBILLE Lou-Anne.</li>
                <li>Créateurs : MEROUANE Idriss, BOIREAU Nahina, VIGIER Robin, BANSRONT Thomas, ZARKA Morgan, DUBILLE Lou-Anne.</li>
                <li>Responsable publication : BANSRONT Thomas, ZARKA Morgan, DUBILLE Lou-Anne, VIGIER Robin.</li>
                <li>Développeurs : DUBILLE Lou-Anne / VIGIER Robin / ZARKA Morgan.</li>
                <li>Web Designer : BOIREAU Nahina / MEROUANE Idriss.</li>
                <li>Rédacteur : BOIREAU Nahina</li>
                <li>Production vidéo : MEROUANE Idriss, BOIREAU Nahina.</li>
                <li>Sound Design : BANSRONT Thomas</li>
                <li>Hébergeur : site hébergé chez HOSTINGER INTERNATIONAL LTD, 61 Lordou Vironos Street, 6023 Larnaca, Chypre</li>
            </ul>

            <h2>2. Conditions générales d’utilisation du site et des services proposés</h2>
            <p>L’utilisation du site Expo Tamara de Lempicka - Les années folles implique l’acceptation pleine et entière des conditions générales d’utilisation ci-après décrites. Ces conditions d’utilisation sont susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site Expo Tamara de Lempicka - Les années folles sont donc invités à les consulter de manière régulière. Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de maintenance technique peut toutefois être décidée par l'équipe, qui s’efforcera alors de communiquer préalablement aux utilisateurs les dates et heures de l’intervention. Le site tamara.sinyart.fr est mis à jour régulièrement par l'équipe. De la même façon, les mentions légales peuvent être modifiées à tout moment : elles s’imposent néanmoins à l’utilisateur qui est invité à s’y référer le plus souvent possible afin d’en prendre connaissance.</p>

            <h2>3. Description des services fournis</h2>
            <p>Le site Expo Tamara de Lempicka - Les années folles a pour objet de fournir une information concernant l’ensemble des activités de l'exposition "Tamara de Lempicka - Les années folles". Tous les informations indiquées sur le site Expo Tamara de Lempicka - Les années folles sont données à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site ne sont pas exhaustifs. Ils sont donnés sous réserve de modifications ayant été apportées depuis leur mise en ligne. Le site Tamara de Lempicka - les années folles est mis à jour régulièrement par l'équipe. De la même façon, les mentions légales peuvent être modifiées à tout moment : elles s’imposent néanmoins à l’utilisateur qui est invité à s’y référer le plus souvent possible afin d’en prendre connaissance.</p>

            <h2>4. Limitations contractuelles sur les données techniques</h2>
            <p>Le site utilise la technologie JavaScript, PHP, HTML et CSS. Le site Internet ne pourra être tenu responsable de dommages matériels liés à l’utilisation du site. De plus, l’utilisateur du site s’engage à accéder au site en utilisant un matériel récent, ne contenant pas de virus et avec un navigateur de dernière génération mis-à-jour.</p>

            <h2>5. Propriété intellectuelle et contrefaçons</h2>
            <p>L'équipe est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous les éléments accessibles sur le site, notamment les textes, images, graphismes, logo, icônes, sons, logiciels. Toute reproduction, représentation, modification, publication, adaptation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de tout les membres de l'équipe. Toute exploitation non autorisée du site ou de l’un quelconque des éléments qu’il contient sera considérée comme constitutive d’une contrefaçon et poursuivie conformément aux dispositions des articles L.335-2 et suivants du Code de Propriété Intellectuelle.</p>

            <h2>6. Limitations de responsabilité</h2>
            <p>L'équipe ne pourra être tenue responsable des dommages directs et indirects causés au matériel de l’utilisateur, lors de l’accès au site Expo Tamara de Lempicka - Les années folles, et résultant soit de l’utilisation d’un matériel ne répondant pas aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une incompatibilité. L'équipe ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une perte de marché ou perte d’une chance) consécutifs à l’utilisation du site Expo Tamara de Lempicka - Les années folles. Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition des utilisateurs. L'équipe se réservent le droit de supprimer, sans mise en demeure préalable, tout contenu déposé dans cet espace qui contreviendrait à la législation applicable en France, en particulier aux dispositions relatives à la protection des données. Le cas échéant, l'équipe se réserve également la possibilité de mettre en cause la responsabilité civile et/ou pénale de l’utilisateur, notamment en cas de message à caractère raciste, injurieux, diffamant, ou pornographique, quel que soit le support utilisé (texte, photographie…).</p>
